...
{
    public partial class T_OD_ASSESSMENTS
    {
        public T_OD_ASSESSMENTS()
        {
            T_OD_ASSESSMENT_CONTENT = new HashSet<T_OD_ASSESSMENT_CONTENT>();
            T_OD_ASSESSMENT_DOCS = new HashSet<T_OD_ASSESSMENT_DOCS>();
            T_OD_CLEANUP_PROJECT = new HashSet<T_OD_CLEANUP_PROJECT>();
        }
        ...
        public ICollection<T_OD_ASSESSMENT_DOCS> T_OD_ASSESSMENT_DOCS { get; set; }
        public ICollection<T_OD_CLEANUP_PROJECT> T_OD_CLEANUP_PROJECT { get; set; }
    }
}
