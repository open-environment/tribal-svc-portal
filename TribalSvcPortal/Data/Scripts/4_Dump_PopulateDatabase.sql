...
--***** WASTE TYPES
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Abandoned automobiles', 'Appliances', 5, UNIT_MSR_IDX, null, 2871, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Abandoned trailers', 'Appliances', 1, UNIT_MSR_IDX, null, 2871, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Animal carcasses', 'Regular', 5, UNIT_MSR_IDX, 225, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Appliances/white goods', 'Appliances', 5, UNIT_MSR_IDX, null, 177, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Construction and demolition wastes', 'Regular', 1, UNIT_MSR_IDX, 750, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Drums/containers of unknowns/pesticide containers', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Electronics', 'Appliances', 5, UNIT_MSR_IDX, null, 177, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Fluorescent light bulbs', 'Hazardous', 5, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Furniture', 'Appliances', 1, UNIT_MSR_IDX, null, 177, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Lead acid batteries', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Medical wastes', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Meth-lab wastes', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Municipal solid waste', 'Hazardous', 5, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Scrap tires', 'Tires', 1, UNIT_MSR_IDX, 300, 50, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='units';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Sewage sludge/septic-tank pumpings', 'Hazardous', 5, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Suspected asbestos or lead containing materials', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Suspected RCRA Subtitle C hazardous wastes (treated wood, paints, solvents)', 'Hazardous', 10, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Waste oils/oily wastes', 'Hazardous', 5, UNIT_MSR_IDX, null, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, DEFAULT_UNIT_MSR_IDX, DENSITY_LBS_CUYD, DENSITY_LBS_UNIT, MODIFY_DT) select 'Yard/green wastes', 'Regular', 1, UNIT_MSR_IDX, 300, null, GETDATE() from T_PRT_REF_UNITS where UNIT_MSR_CD='cu-yds';
