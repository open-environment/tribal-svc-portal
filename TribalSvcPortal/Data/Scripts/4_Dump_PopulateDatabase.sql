...
--***** WASTE TYPES
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Abandoned automobiles', 'Regular', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Abandoned trailers', 'Regular', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Animal carcasses', 'Regular', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Appliances/white goods', 'Appliances', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Construction and demolition wastes', 'Regular', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Drums/containers of unknowns/pesticide containers', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Electronics', 'Appliances', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Fluorescent light bulbs', 'Regular', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Furniture', 'Appliances', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Lead acid batteries', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Medical wastes', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Meth-lab wastes', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Municipal solid waste', 'Hazardous', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Scrap tires', 'Tires', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Sewage sludge/septic-tank pumpings', 'Hazardous', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Suspected asbestos or lead containing materials', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Suspected RCRA Subtitle C hazardous wastes (treated wood, paints, solvents)', 'Hazardous', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Waste oils/oily wastes', 'Hazardous', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_WASTE_TYPE_NAME, REF_WASTE_TYPE_CAT, REF_WASTE_HAZFACT_SUBSCORE, MODIFY_DT) VALUES ('Yard/green wastes', 'Regular', 1, GETDATE());

UPDATE T_OD_REF_WASTE_TYPE  set REF_WASTE_TYPE_CAT = 'Regular';
GO
UPDATE T_OD_REF_WASTE_TYPE  set REF_WASTE_TYPE_CAT = 'Hazardous' where REF_WASTE_TYPE_NAME in ('Drums/containers of unknowns/pesticide containers','Lead acid batteries','Medical wastes', 'Meth-lab wastes','Municipal solid waste', 'Municipal solid waste', 'Sewage sludge/septic-tank pumpings', 'Suspected asbestos or lead containing materials', 'Suspected RCRA Subtitle C hazardous wastes (treated wood, paints, solvents)', 'Waste oils/oily wastes');
UPDATE T_OD_REF_WASTE_TYPE  set REF_WASTE_TYPE_CAT = 'Appliances' where REF_WASTE_TYPE_NAME in ('Appliances/white goods', 'Electronics', 'Furniture');
UPDATE T_OD_REF_WASTE_TYPE  set REF_WASTE_TYPE_CAT = 'Tires' where REF_WASTE_TYPE_NAME in ('Scrap tires');
