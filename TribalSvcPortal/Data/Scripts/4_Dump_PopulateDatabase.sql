...
--***** WASTE TYPES
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Abandoned automobiles', 'Abandoned automobiles', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Abandoned trailers', 'Abandoned trailers', 'Hazard Factor', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Animal carcasses', 'Animal carcasses', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Appliances/white goods', 'Appliances/white goods', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Construction and demolition wastes', 'Construction and demolition wastes', 'Hazard Factor', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Drums/containers of unknowns/pesticide containers', 'Drums/containers of unknowns/pesticide containers', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Electronics', 'Electronics', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Fluorescent light bulbs', 'Fluorescent light bulbs', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Furniture', 'Furniture', 'Hazard Factor', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Lead acid batteries', 'Lead acid batteries', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Medical wastes', 'Medical wastes', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Meth-lab wastes', 'Meth-lab wastes', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Municipal solid waste', 'Municipal solid waste', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Scrap tires', 'Scrap tires', 'Hazard Factor', 1, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Sewage sludge/septic-tank pumpings', 'Sewage sludge/septic-tank pumpings', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Suspected asbestos or lead containing materials', 'Suspected asbestos or lead containing materials', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Suspected RCRA Subtitle C haz waste (treated wood, paints, solvents)', 'Suspected RCRA Subtitle C hazardous wastes (treated wood, paints, solvents)', 'Hazard Factor', 10, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Waste oils/oily wastes', 'Waste oils/oily wastes', 'Hazard Factor', 5, GETDATE());
INSERT INTO T_OD_REF_WASTE_TYPE (REF_DATA_VAL, REF_DATA_DESC, REF_DATA_CAT_NAME, REF_DATA_SCORE, CREATE_DT) VALUES ('Yard/green wastes', 'Yard/green wastes', 'Hazard Factor', 1, GETDATE());
