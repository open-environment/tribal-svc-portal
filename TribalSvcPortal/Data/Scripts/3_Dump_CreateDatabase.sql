...
Scaffold-DbContext -UseDatabaseNames "Server=.\SQLEXPRESS;Database=TRIBAL_SVC_PORTAL;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir Data/Models -t T_OD_DUMP_ASSESSMENTS, T_OD_DUMP_ASSESSMENT_DOCS, T_OD_REF_DATA_CATEGORIES, T_OD_REF_DATA, T_OD_SITES  -f -Context "ApplicationDbContextTemp"
*/
...
CREATE TABLE [dbo].[T_OD_REF_WASTE_TYPE_CAT_CLEANUP](
	...
	[PROCESS_RATE_UNIT] [VARCHAR](10)  NULL,
...
CREATE TABLE [dbo].[T_OD_REF_WASTE_TYPE](
	...
	[MODIFY_USER_ID] nvarchar(450) NULL,
	[MODIFY_DT] datetime2(0) NULL,
 CONSTRAINT [PK_T_OD_REF_FACTORS] PRIMARY KEY CLUSTERED  ([REF_FACTOR_IDX] ASC)
) ON [PRIMARY]
...
CREATE TABLE [T_OD_SITES] (
	...
	[RESPONSE_ACTION] uniqueidentifier NULL,
    ...
    CONSTRAINT [FK_T_OD_SITE_DTL_R] FOREIGN KEY ([RESPONSE_ACTION]) REFERENCES [T_OD_REF_DATA] ([REF_DATA_IDX]),
    CONSTRAINT [FK_T_OD_SITE_DTL_SS] FOREIGN KEY ([SITE_SETTING_IDX]) REFERENCES [T_OD_REF_DATA] ([REF_DATA_IDX]),
    CONSTRAINT [FK_T_OD_SITE_DTL_AD] FOREIGN KEY ([PF_AQUIFER_VERT_DIST]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_SITE_DTL_SD] FOREIGN KEY ([PF_SURF_WATER_HORIZ_DIST]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_SITE_DTL_HD] FOREIGN KEY ([PF_HOMES_DIST]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX])
);
GO
...
--	[MAINTAINED_IND] bit NOT NULL DEFAULT 0,
    ...
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFR] FOREIGN KEY ([HF_RAINFALL]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFD] FOREIGN KEY ([HF_DRAINAGE]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFF] FOREIGN KEY ([HF_FLOODING]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFB] FOREIGN KEY ([HF_BURNING]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFFN] FOREIGN KEY ([HF_FENCING]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFA] FOREIGN KEY ([HF_ACCESS_CONTROL]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX]),
    CONSTRAINT [FK_T_OD_DUMP_ASSESSMENTS_HFP] FOREIGN KEY ([HF_PUBLIC_CONCERN]) REFERENCES [T_OD_REF_FACTORS] ([REF_FACTOR_IDX])
);
...
(
	...
	[DUMP_ASSESSMENTS_IDX] uniqueidentifier NOT NULL,
	[REF_WASTE_IDX] uniqueidentifier NOT NULL,
    ...
    CONSTRAINT [FK_T_OD_DUMP_ASSESS_CNT_D] FOREIGN KEY ([REF_WASTE_IDX]) REFERENCES [T_OD_REF_WASTE] ([REF_FACTOR_IDX])
);