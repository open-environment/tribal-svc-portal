...
--   ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_CLEANUP_AMT DECIMAL(12,2) NULL;
--  ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_TRANSPORT_AMT DECIMAL(12,2) NULL;
--  ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_DISPOSAL_AMT DECIMAL(12,2) NULL;   
--  ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_RESTORE_AMT DECIMAL(12,2) NULL;   
--  ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_SURVEIL_AMT DECIMAL(12,2) NULL;   
--  ALTER TABLE T_OD_DUMP_ASSESSMENTS ADD COST_TOTAL_AMT DECIMAL(12,2) NULL;   
