...
/*
	...
	drop table [T_OD_CLEANUP_TRANSPORT_DTL];
...
CREATE TABLE [T_OD_CLEANUP_TRANSPORT_DTL] 
(
	[CLEANUP_TRANSPORT_DTL_IDX] uniqueidentifier NOT NULL DEFAULT NEWID(),
	[CLEANUP_PROJECT_IDX] uniqueidentifier NOT NULL,
	[REF_WASTE_TYPE_IDX] uniqueidentifier NOT NULL,
	[NUM_LOADS] int NULL,
	[HOURS_LOAD] decimal(10,2) NULL,
	[HOURLY_RATE] decimal(10,2) NULL,
	[TRANSPORT_COST] decimal(10,2) NULL,
    CONSTRAINT [PK_T_OD_CLEANUP_TRANSPORT_DTL] PRIMARY KEY ([CLEANUP_TRANSPORT_DTL_IDX]),
    CONSTRAINT [FK_T_OD_CLEANUP_TRANSPORT_DTL] FOREIGN KEY ([CLEANUP_PROJECT_IDX]) REFERENCES [T_OD_CLEANUP_PROJECT] ([CLEANUP_PROJECT_IDX]) ON UPDATE CASCADE ON DELETE CASCADE
);
