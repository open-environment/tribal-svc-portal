...
GO
--ALTER TABLE [T_PRT_USERS] ADD [LAST_LOGIN_DT] datetime2(0) NULL;
...
GO
--ALTER TABLE T_PRT_SITES ADD [LAND_STATUS] varchar(30) NULL;
--ALTER TABLE T_PRT_SITES ADD [TWP] varchar(3) NULL;
--ALTER TABLE T_PRT_SITES ADD [RANGE] varchar(4) NULL;
--ALTER TABLE T_PRT_SITES ADD [SECTION] int NULL;
--ALTER TABLE T_PRT_SITES ADD [COUNTY] varchar(30) NULL;
