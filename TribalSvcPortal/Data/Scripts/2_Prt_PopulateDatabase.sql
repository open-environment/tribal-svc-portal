...
values ('open_waters','Open Waters', 'IMPLICIT', 'http://localhost:59412/signinoidc','http://localhost:59412/signoutcallbackoidc','http://localhost:59412/App_Pages/Secure/Dashboard.aspx', false);

INSERT INTO T_PRT_CLIENTS (CLIENT_ID, CLIENT_NAME, CLIENT_GRANT_TYPE, CLIENT_REDIRECT_URI, CLIENT_POST_LOGOUT_URI, CLIENT_URL, CLIENT_LOCAL_IND)
values ('open_dump','Open Dump', 'IMPLICIT', 'http://localhost:1245/signinoidc','http://localhost:1245/signoutcallbackoidc','http://localhost:1245/Dashboard/Index',true);

INSERT INTO T_PRT_CLIENTS (CLIENT_ID, CLIENT_NAME, CLIENT_GRANT_TYPE, CLIENT_REDIRECT_URI, CLIENT_POST_LOGOUT_URI, CLIENT_URL, CLIENT_LOCAL_IND)
values ('emergency_hound','Emergency Hound Web', 'IMPLICIT', 'http://localhost:1244/signinoidc','http://localhost:1244/signoutcallbackoidc','http://localhost:1244/Dashboard/Index', false);
